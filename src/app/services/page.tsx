      ...
      <section className="relative py-24 lg:py-32" style={{ background: "#FFFFFF" }}>
        <div className="relative mx-auto max-w-[1440px] px-6 lg:px-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-6">
            <ServiceCard title="AML/CFT Risk Tools" subtitle="Risk-rating engines, customer scoring, screening calibration and monitoring tuning built on UAE typologies, not imported templates." image="https://images.unsplash.com/photo-1633158829585-23ba8f7c8caf?auto=format&fit=crop&w=800&q=80" />
            <ServiceCard title="Sanctions Screening" subtitle="List management, fuzzy-match tuning and alert disposition for OFAC, UN, EU, UK and UAE local lists with the QA trail to defend each call." image="https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80" />
            <ServiceCard title="Transaction Monitoring" subtitle="Scenarios that catch what matters. Tuning that keeps false positives under control. Managed L1/L2 alert handling under SLA." image="https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?auto=format&fit=crop&w=800&q=80" />
            <ServiceCard title="Fraud Risk Management" subtitle="Application, transaction and identity fraud frameworks with rule libraries, model oversight and case workflows that close the loop." image="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&w=800&q=80" />
            <ServiceCard title="MIS Dashboards" subtitle="Power BI, Tableau and bespoke dashboards for risk, compliance, finance and operations instrumented for the committee, not the screensaver." image="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=80" />
            <ServiceCard title="Website Development" subtitle="Corporate, brand and product sites for regulated firms accessible, fast and built around UAE PDPL and cookie-consent rules from day one." image="https://images.unsplash.com/photo-1547658719-da2b51169166?auto=format&fit=crop&w=800&q=80" />
            <ServiceCard title="Training & Certification" subtitle="FATF-style assessor prep, AML/CFT and sanctions training, board briefings and tailored learning paths for compliance, audit and front-line teams." image="https://images.unsplash.com/photo-1524178232363-1fb2b075b655?auto=format&fit=crop&w=800&q=80" />
            <ServiceCard title="Payroll Management" subtitle="WPS-aligned payroll, gratuity, leave accruals and statutory reporting run on time, audit-clean, no last-minute scramble." image="https://images.unsplash.com/photo-1554224155-1696413565d3?auto=format&fit=crop&w=800&q=80" />
            <ServiceCard title="Payroll & Compliance Bundle" subtitle="Payroll plus labour, tax and statutory compliance MOHRE, FTA, ESR, UBO and corporate tax obligations under a single managed service." image="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=800&q=80" />
            <ServiceCard title="Auditing Services" subtitle="Statutory, internal and special-purpose audits including AML, sanctions and fraud audits with the evidence pack a supervisor can rely on." image="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=800&q=80" />
            <ServiceCard title="Bank Account Opening" subtitle="Corporate account opening with UAE banks KYC packs, source-of-wealth narratives and the relationship management that gets you past onboarding." image="https://images.unsplash.com/photo-1573497620053-ea5300f94f21?auto=format&fit=crop&w=800&q=80" />
            <ServiceCard title="Feasibility Studies" subtitle="Market sizing, licensing pathway, operating model and financials written so a board, a regulator and a lender can read it the same way." image="https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&w=800&q=80" />
          </div>
        </div>
      </section>
